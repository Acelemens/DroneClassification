...
# 修改后的 ResNet18（加通道注意力）
class ResNetWithChannelAttention(ResNet):
    def __init__(self):
...
if __name__ == "__main__":
    ...
    if best_model_state is not None:
        ...
        torch.save(best_model_state, "../models/resnet18_channel.pth")
        print("最佳模型已保存为 models/resnet18_channel.pth")
        print(f"最佳验证损失: {best_val_loss:.4f}")
    else:
        torch.save(model.state_dict(), "../models/resnet18_channel.pth")
        print("模型已保存为 models/resnet18_channel.pth")
