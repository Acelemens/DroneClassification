...
# 轻量版带自注意力的 ResNet18
class ResNetWithSelfAttentionLite(ResNet):
    def __init__(self):
    ...
    def _forward_impl(self, x):
        ...
        x = self.layer1(x)  # 不加 attention
        x = self.layer2(x)  # 不加 attention
...
if __name__ == "__main__":
    ...
    model = ResNetWithSelfAttentionLite()
    ...
    # 7. 保存最佳模型
    save_path = "../models/resnet18_selfatt_light.pth"
